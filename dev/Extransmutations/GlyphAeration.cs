  ...
  public static void Activate(bool firstHalf, Sim sim, SolutionEditorBase seb, Part part, Resources t) {
    ...
    if (firstHalf && sim.FindAtomRelative(part, new(0, 0)).method_99(out AtomReference saltSpot)) {
      ...
      if (doTransmute) {      
        ...
        seb.field_3935.Add(new class_228(seb, (enum_7)1, class_187.field_1742.method_492(part.method_1184(new HexIndex(0, 0))), t.aerationBreathe, 8f*2f, Vector2.Zero, rotation));
